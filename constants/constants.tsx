...
export const emissionRate = 500000 * NATIVE_TOKEN_MULTIPLIER; //Per day
...
export const bannerText = `Launch Phase 1: No limit on transaction value, emission rate is 500k HBAR per day.`;
